...
export default class extends Controller {
  static targets = [CONSTANTS.TARGETS.MENU, CONSTANTS.TARGETS.ICONON, CONSTANTS.TARGETS.ICONOFF];
  static classes = [
  ...
  _show() {
    ...
    this.iconOnTarget.classList.remove(this.hideClass);
    this.iconOffTarget.classList.add(this.hideClass);
  ...
  _hide() {
    this.iconOnTarget.classList.add(this.hideClass);
    this.iconOffTarget.classList.remove(this.hideClass);
