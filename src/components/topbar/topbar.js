...
export default function Topbar({ character, characters, setSidebarOpen, setNewCharOpen }) {
  return (
    <div className="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 xl:border-none">
      <button
        className="px-4 border-r border-gray-200 text-gray-400 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-cyan-500 xl:hidden"
